...
const UserForm: React.FC = () => {
  ...
  return (
    <div>
      <MainContainer>
        <HeaderContainer>
          <HeaderIndexButton label="register" viewId="register" />
          <HeaderIndexButton label="parameters" viewId="analysis" />
          <HeaderIndexButton label="density" viewId="result" />
          <HeaderIndexButton label="mds" viewId="mds" />
          {/* <HeaderIndexButton label="diagnosis" viewId="diagnosis" />
          <HeaderIndexButton label="log" viewId="log" /> */}
          <DisplayFailedMessage Content={HeaderWarningButton} />
          {nowComputation ? <Loader onClick={onClickLoader} /> : <></>}
        </HeaderContainer>
        <ContentsContainer>
          <ToggleView viewId="register" Content={RegisterViewSummary} />
          <ToggleView viewId="mds" Content={MdsView} />
          <ToggleView viewId="analysis" Content={AnalysisView} />
          <ToggleView viewId="result" Content={ResultView} />
          <ToggleView viewId="warning" Content={WarningViewSummary} />
          <ToggleView viewId="log" Content={ProgressViewSummary} />
        </ContentsContainer>
      </MainContainer>
    </div>
  );
