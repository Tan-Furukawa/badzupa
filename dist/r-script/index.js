...
const rScriptModulePath = __dirname.replace('app.asar', 'app.asar.unpacked');
...
function R(path) {
  ...
  this.path = path;
  this.options = {
    env: _.extend({ DIRNAME: rScriptModulePath }, process.env),
    encoding: "utf8"
  };
  this.idCounter = 0;
  this.args = ["--vanilla", rScriptModulePath + "/R/launch.R"];
}
